describe("test Login Feature",()=>{
    ...
    it("Login with valid username and password",()=>{
        ...
        cy.get('#item_4_img_link').find('[src="./img/sauce-backpack-1200x1500.jpg"]').should('be.exist')
    ...
    it("Login with problem user",()=>{
        ...
        cy.get('#password').clear().type("secret_sauce")
        cy.get('input[type="submit"]').should('be.visible').click()
        cy.get('#item_4_img_link').find('[src="./img/sauce-backpack-1200x1500.jpg"]').should('not.exist')
    })
})